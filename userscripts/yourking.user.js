...
// @version      0.1
// @require      https://raw.githubusercontent.com/salsan/customizechessboard/master/cc.js
// @description  Play all match with your King ( Alessandro Santagati )
// @author       salsan
...
(function() {
    ...
    setPieces( myChessboard );

    console.log("La scacchiera è ruotata : " + ( isRotated() === true ) );

    if ( myChessboard.chessboard.length > 0 ){
     setChessboard ( myChessboard.chessboard )
    }
